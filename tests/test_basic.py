...
def test_power_of_two_exponent_10n_py():
    ...
    assert (
        res[-2]
        == "4573536648073116712502659212705508520418524335224287996399854941049366806437310995625742046215396793754803629590173942305493553167642242743069098817056046992680891830197061490109937833490419136188999442576576769103890995893380022607743740081787109376"
    )
    assert (
        res[-1]
